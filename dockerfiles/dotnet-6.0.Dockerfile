...
RUN mkdir /app/src
RUN echo 'System.Console.WriteLine("If you are seeing this outside the [build] step, there is something wrong with our caching mechanism! Please contact us at hello@codecrafters.io.");' > /app/src/Program.cs
